...
Prioritize reducing decision fatigue. Consider due dates, difficulty, mood, energy, and tiny subtasks.
Return JSON exactly like:
{
  "task": "one recommended task or subtask",
  "reason": "brief reason this is the best next step",
  "timeEstimate": "10-25 minutes",
  "steps": ["first tiny step", "second tiny step", "third tiny step"],
  "encouragement": "warm closing"
}
Mood: ${payload.mood || 3}/5
Energy: ${payload.energy || 3}/5
Open tasks: ${JSON.stringify(payload.tasks || [])}
Routines: ${JSON.stringify(payload.routines || [])}`,
